...
namespace Khanhlyluyentap1.Controllers
{
    public class SinhVienController : Controller
    {
        ...
        public async Task<IActionResult> Details(string id)
        {
            ...
            var testStringProcess = StringProcessLyMSV.LowerToUpper(id);
        ...
        public async Task<IActionResult> Create([Bind("MaSinhVien,TenSinhVien,GioiTinh")] SinhVien sinhVien)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(string id, [Bind("MaSinhVien,TenSinhVien,GioiTinh")] SinhVien sinhVien)
        {
